...
<span style="color: red"><strong>(!)</strong></span> Code documentation generated by [TypeDoc](https://typedoc.org/) is available at [**prg-frontend**](./prg-frontend).
...
<span style="color: red"><strong>(!)</strong></span> Code documentation generated by [Doxygen](https://www.doxygen.nl/) is available at [**prg-backend**](./prg-backend).
